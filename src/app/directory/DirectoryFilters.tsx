    ...
    <div className="flex flex-col sm:flex-row gap-3">
      <div className="flex-1">
        <input
          ...
          className="w-full px-4 py-2.5 rounded-lg bg-surface-lowest text-foreground placeholder:text-muted text-sm focus:outline-none focus:ring-1 focus:ring-secondary/30 transition-all"
        />
      </div>
      ...
      <select
        ...
        className="px-4 py-2.5 rounded-lg bg-surface-lowest text-foreground text-sm focus:outline-none focus:ring-1 focus:ring-secondary/30 transition-all appearance-none cursor-pointer"
      >
